...
export const DEFAULT_PARAMETERS: Array<{
  ...
  { key: 'MIN_STAKE_WEI', value: 0.01, unit: 'ether', category: 'staking', description: 'Minimum stake required for Tier 2 listing' },
  ...
  { key: 'INSURANCE_POOL_CAP', value: 100, unit: 'ether', category: 'insurance', description: 'Maximum insurance pool balance cap' },
  { key: 'REVIEW_BOND_WEI', value: 0.001, unit: 'ether', category: 'review', description: 'Bond required to submit a review' },
